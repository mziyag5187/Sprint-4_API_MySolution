...
public class LibraryAPI_Util {
    ...
    public static Map<String,Object> getRandomNewItemInfo(String postBody){
        Map<String,Object> resultMap = new LinkedHashMap<>();
        switch (postBody){
            case "book":
                resultMap = LibraryAPI_Util.getRandomBookMap();
                break;
            case "user":
                resultMap = LibraryAPI_Util.getRandomUserMap();
        }
        return resultMap;
    }
